        ...
        <div className="col-lg-11">
          <div className="img mb-80">
            <img
              ...
              alt={singleProject?.image?.public_id}
              className="radius-5"
            />
          </div>
          <div className="row justify-content-center">
              ...
              <div className="cont md-mb50">
                ...
                <div className="mt-30">
                  ...
                  <ul className="rest list-arrow mt-50">
                    {
                      singleProject?.techStack?.map((item) => {
            ...
            <div className="row md-marg">
              <div className="col-md-6">
                <div className="img sm-mb30">
                  <img src={singleProject?.image?.url} alt={singleProject?.image?.public_id} />
                </div>
              </div>
              <div className="col-md-6">
                <div className="img">
        ...
        <div className="row justify-content-center">
          <div className="col-lg-11">
            <div className="d-flex align-items-center mt-80 pt-80 bord-thin-top">
              <div className="prev">
                <h6 className={`sub-title ${singleProject.prev ? 'd-block' : 'd-none'}`}>
                  <a href={`/l-single-project/${singleProject.prev}`}>
                    <i className="fas fa-long-arrow-alt-left"></i> Prev Project
                  </a>
                </h6>
              </div>
              <div className="next ml-auto">
                <h6 className={`sub-title ${singleProject.next ? 'd-block' : 'd-none'}`}>
                  <a href={`/l-single-project/${singleProject.next}`}>
